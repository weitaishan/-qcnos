...
- (void)addBaseTableViewWithFrame:(CGRect)frame style:(UITableViewStyle)style{
...
-(void)addTableViewWithGroupFrame:(CGRect)frame{
    ...
    [self addBaseTableViewWithFrame:frame style:UITableViewStyleGrouped];
...
- (NSAttributedString *)titleForEmptyDataSet:(UIScrollView *)scrollView
{
    ...
    NSDictionary *attributes = @{NSFontAttributeName: [UIFont systemFontOfSize:12],
                                 NSForegroundColorAttributeName: kBgColor};
