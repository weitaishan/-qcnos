...
#import "QCImagePicker.h"

@interface QCImagePicker()<UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
static QCImagePicker *bdImagePickerInstance = nil;

@implementation QCImagePicker
...
+ (void)showImagePickerFromViewController:(UIViewController *)viewController allowsEditing:(BOOL)allowsEditing finishAction:(BDImagePickerFinishAction)finishAction {
    if (bdImagePickerInstance == nil) {
        bdImagePickerInstance = [[QCImagePicker alloc] init];
    }
